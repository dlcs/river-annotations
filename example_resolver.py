...
def get_anno_details(arguments):
    ...
    details['canvasURI'] = "http://waylon.rcvsvethistory.org/work/" + canvas_1 + "/canvas/" + canvas_2

    details['imageURI'] = "https://dlcs.io/iiif-img/50/1/" + arguments.get('image')

    details['annotationBaseURI'] = "http://waylon.rcvsvethistory.org/work/" + arguments.get('anno') + "/annos/contentAsText/{{line_number}}"
